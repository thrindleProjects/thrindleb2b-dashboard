...
interface CompletedOrderTableProps {
  orders: SingleOrder[];
}

type CompletedOrderTableType = React.FC<CompletedOrderTableProps>;

const CompletedOrderTable: CompletedOrderTableType = ({ orders }) => {
  return (
    <section className='flex w-full flex-col gap-5 bg-white py-5'>
      <div className='flex items-center justify-between px-4'>
        <h5 className='text-base font-medium xl:text-lg'>Completed Orders</h5>
        <div>Pagination</div>
      </div>
