...
type PendingOrderTableType = React.FC<PendingOrderTableProps>;

const PendingOrderTable: PendingOrderTableType = ({ orders }) => {
  return (
    <section className='flex w-full flex-col gap-5 bg-white py-5'>
      <div className='flex items-center justify-between px-4'>
        <h5 className='text-base font-medium xl:text-lg'>Pending Orders</h5>
        <div>Pagination</div>
      </div>
