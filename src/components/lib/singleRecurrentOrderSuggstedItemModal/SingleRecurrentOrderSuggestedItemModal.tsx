...
import SingleRecurrentOrderSuggestedItemForm from '@/components/lib/singleRecurrentOrderSuggestedItemForm';
import SingleRecurrentOrderSuggestedItemList from '@/components/lib/singleRecurrentOrderSuggestedItemList';

interface SingleRecurrentOrderSuggestedItemMoalProps {
  isOpen: boolean;
  close: () => void;
}

type SingleRecurrentOrderSuggestedItemModalType =
  React.FC<SingleRecurrentOrderSuggestedItemMoalProps>;

const SingleRecurrentOrderSuggestedItemModal: SingleRecurrentOrderSuggestedItemModalType =
  ({ close, isOpen }) => {
    return (
      <Modal
        isOpen={isOpen}
        ...
        <div className='grid h-full grid-rows-[auto_1fr] gap-8 pb-8'>
          ...
          <div className='grid h-full grid-cols-2 overflow-hidden px-8'>
            <div className='bg-primary-grey no-scrollbar h-full w-full overflow-y-auto px-4 py-5'>
              ...
              <SingleRecurrentOrderSuggestedItemForm />
            </div>
...
export default SingleRecurrentOrderSuggestedItemModal;
